...
router.get('/page/:page',function(req,res,next){
    ...
    conn.query(sql,function(err,rows){
        ...
        res.render('page',{title : '질문 게시판',rows:rows,page:page,length:rows.length-1,page_num:5,pass:true});
...
router.get('/write',function(req,res,next){
    res.render('write',{title:"질문 게시판 글 쓰기"});
});
